        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            ...
            <div class="navbar-nav">
                ...
                <a class="nav-link " href="/karyawan/pemesanan1">Pemesanan</a>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form method="POST" action="/karyawan/profil/edit" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="editpassword" tabindex="-1" aria-labelledby="editpasswordLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form method="POST" action="/karyawan/profil/editpassword">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}"/>
                    <input type="hidden" class="form-control" value="{{Auth::user()->id}}" name="id">
                    <div class="mb-3">
