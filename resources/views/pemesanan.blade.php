            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" readonly class="form-control-plaintext" id="staticEmail" value="{{ $p-> no_meja }}">
                  </div>
                </div>
                <div class="mb-3 row">
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" readonly class="form-control-plaintext" id="staticEmail" value="{{ $p-> metode_pembayaran }}">
                  </div>
                <div class="mb-3 row">
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-sm-8">
                    <img src="/img/{{ $p-> bukti_transfer }}" height="70%" width="30%" alt="" type="text" readonly class="form-control-plaintext" id="staticEmail">
                  </div>
                </div>
                <div class="modal-footer">
...
<div class="modal fade" id="upload{{ $p->id_pesanan }}" tabindex="-1" aria-labelledby="uploadLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="uploadLabel">Kirim ulang bukti transfer</h5>
      </div>
